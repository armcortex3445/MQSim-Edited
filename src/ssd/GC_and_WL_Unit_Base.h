...
namespace SSD_Components
{
	...
	*/
	...
	protected:
		...
		bool is_going_write_gc_wl_candidate(const NVM::FlashMemory::Physical_Page_Address& plane_address, const flash_block_ID_type gc_wl_candidate_block_id);	//Added Function for solving race condition. By Seong Jihwan.
		bool use_copyback;
