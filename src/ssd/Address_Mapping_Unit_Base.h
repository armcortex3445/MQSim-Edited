...
namespace SSD_Components
{
	...
	public:
		...
		**********************************************************************************************************************/
		...
		//GC 실행이 plane에서 종료되거나 , plane이 write를 수행하기 위한 free page의 개수가 충분하다면, 해당 함수가 호출된다.
		virtual bool is_logical_page_locked_for_gc(stream_id_type stream_id, LPA_type lpa, bool mappingpage) = 0;  
	protected:
		FTL* ftl;
