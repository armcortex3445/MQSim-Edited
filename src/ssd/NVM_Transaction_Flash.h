...
namespace SSD_Components
{
	...
	public:
		...
		sim_time_type Estimated_alone_waiting_time = 0;//Used in scheduling methods, such as FLIN, where fairness and QoS is considered in scheduling

		bool FLIN_Barrier;//Especially used in queue reordering in FLIN scheduler


		//Added variable for Using FLIN Algorithm. By Seong Jihwan.
		sim_time_type Transfer_memory_time=0; // T_transfer + T_finish°ª
