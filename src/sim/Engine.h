...
namespace MQSimEngine {
	class Engine
	{
		friend class EventTree; //EvnetTree private 영역에도 접근 가능
	public:
		Engine()
		{
			//EventTree 클래스 타입 변수 _EventList에 메모리 할당.
		...
		int Get_sim_event_count();//Added Function for using FLIN Algorithm by Seong Jihwan.
	private:
