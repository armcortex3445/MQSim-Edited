...
#define NVME_UPDATE_SQ_TAIL(Q)  Q.Submission_queue_tail++;\
	...
	protected:
		...
		sim_time_type STAT_sum_device_response_time_quotien=0, STAT_sum_device_response_time_remainder=0;
		sim_time_type STAT_sum_request_delay_qutoien = 0, STAT_sum_request_delay_remainder = 0;
